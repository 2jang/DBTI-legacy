...
-   **웹-서버 간 비동기 통신**: fetch를 사용하여 웹 프론트엔드와 Flask 서버 간에 비동기적으로 통신합니다.
-   **웹 크롤링을 통한 데이터 구축**: `mbti_crawling.py` 스크립트로 외부 웹사이트에서 MBTI 관련 데이터를 수집하고 CSV 파일로 저장합니다.
-   **정보 시각화**: 카카오톡 카드를 활용하여 DBTI, MBTI 및 견종 추천 정보를 효과적으로 전달합니다.
- 
